...
export const content = {
  ...
  admin: {
    ...
    login: {
      ...
      demo: {
        title: "Demo accounts",
        description: "Only shown in this demo. Every account is an admin and uses the same password:",
        use: "Use this account",
        accounts: [{ name: "Ramon Villareal", email: "admin@carrental.example" }],
      },
    },
    common: {
      search: "Search",
    ...
    users: {
      title: "Users",
      description: "Staff accounts. Everyone here is an admin and can do everything.",
      columns: { name: "Name", email: "Email", status: "Status", actions: "Actions" },
      ...
      errors: {
        ...
        last_admin: "At least one account must stay active.",
