...
export const content = {
  ...
  account: {
    login: {
      meta: { title: "Log in", description: "Log in to fill in your booking details faster." },
      title: "Log in",
      subtitle: "Log in to fill in your details for you next time you book.",
      google: "Continue with Google",
      apple: "Continue with Apple",
      or: "or",
      methodsLabel: "How do you want to log in?",
      tabPassword: "Email and password",
      tabCode: "Email code",
      email: "Email",
      password: "Password",
      submit: "Log in",
      ...
      code: "6-digit code",
      codeDemoNote: "Demo only: no email is sent. Any 6 digits work.",
      verify: "Log in",
      ...
      errors: {
        ...
        invalid_code: "That code is not right. Enter the 6 digits from the email.",
        no_account: "We could not find an account with that email. You can create one instead.",
        unknown: "We could not log you in. Please try again.",
      },
      demo: {
        title: "Demo customer",
        description: "Only shown in this demo. This customer has booked before, so the saved-details prompt appears in the booking.",
    ...
    signup: {
      meta: { title: "Sign up", description: "Create an account to fill in your booking details faster." },
      title: "Create an account",
      subtitle: "Your details are saved after you book, so next time we can fill them in for you.",
      name: "Full name",
      email: "Email",
      password: "Password",
      ...
      loginLink: "Log in",
      errors: {
        duplicate_email: "An account with that email already exists. Try logging in instead.",
  ...
  booking: {
    ...
    details: {
      ...
      savedDetails: {
        title: "Use your saved details?",
        description: "We can fill in your name, email, phone and license number from your account. You can still change them.",
        yes: "Yes, fill them in",
        no: "No, I will type them",
      },
      loginPrompt: {
        text: "Have an account? Log in to fill in your details for you.",
        link: "Log in",
      },
